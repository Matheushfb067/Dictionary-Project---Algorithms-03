...
treenode *arvore = NULL; // <<< CORREÇÃO 1: A árvore deve ser global
...
void cadastrarPalavra()
{
    ...
    // treenode *arvore = NULL; // <<< REMOVIDO: Não deve ser local
    ...
    if (indicePalavra != -1)
    {
        ...
        // tInsert(arvore, nomeFicticio); // <<< REMOVIDO: Inserção é só para novas palavras e o tipo estava errado
    ...
    else
    {
        ...
        // <<< CORREÇÃO 2: Insere a NOVA palavra (a struct completa) na árvore
